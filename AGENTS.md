# startup — instrucciones para Codex

## Triggers — cuando aplicar estas instrucciones

Aplicar cuando el usuario mencione: emprendimiento, startup, FONTAR, FONSOFT, ANR, SEPyME, constituir empresa, SAS, SRL, equity, cap table, pitch, financiamiento para emprendedores, ecosistema emprendedor Argentina.
